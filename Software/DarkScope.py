...
class Window(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.Senstivity = QLabel("Senstivity: 2V/Div")
        self.Coupling = QLabel("Coupling: AC")
        self.Sampling = QLabel("Sampling: 2048 Samples")
        self.Buffer = QLabel("Buffer: 2048 Samples")
